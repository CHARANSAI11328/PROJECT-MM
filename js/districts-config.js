/**
 * MAMEKA MAHODAYAM - Centralized District & Location Configuration
 * Authoritative single source of truth for the complete Andhra Pradesh District -> Revenue Division -> Mandal hierarchy.
 * Shared across Navigation, Dropdown, Ingestion, Admin, Database & Public Search/Filters.
 */
...
(function (root, factory) {
  ...
  // 1. MASTER AP DISTRICTS LIST (27 AP Districts + Telangana / Bureau)
  const AP_DISTRICTS = [
    {
      code: 'all',
    ...
    },
    {
      ...
      name_te: 'అనకాపల్లి',
      slug: 'anakapalli',
      keywords: ['anakapalli', 'అనకాపల్లి', 'నర్సీపట్నం', 'చోడవరం']
    },
    {
      code: 'anantapur',
      name_en: 'Anantapur',
      name_te: 'అనంతపురం',
      slug: 'anantapur',
      keywords: ['anantapur', 'అనంతపురం', 'తాడిపత్రి', 'గుంతకల్లు', 'కళ్యాణదుర్గం']
    },
    {
      code: 'annamayya',
      name_en: 'Annamayya',
      name_te: 'అన్నమయ్య',
      slug: 'annamayya',
      keywords: ['annamayya', 'అన్నమయ్య', 'rayachoti', 'రాజంపేట', 'రాయచోటి', 'మదనపల్లె']
    },
    {
      code: 'asr',
      ...
      aliases: ['asr'],
      keywords: ['asr', 'alluri', 'సీతారామరాజు', 'పాడేరు', 'అరకు', 'రంపచోడవరం']
    },
    {
      code: 'bapatla',
      name_en: 'Bapatla',
      name_te: 'బాపట్ల',
      slug: 'bapatla',
      keywords: ['bapatla', 'బాపట్ల', 'చీరాల', 'రేపల్లె', 'వేమూరు']
    },
    {
      code: 'chittoor',
      name_en: 'Chittoor',
      name_te: 'చిత్తూరు',
      slug: 'chittoor',
      keywords: ['chittoor', 'చిత్తూరు', 'కుప్పం', 'నగరి', 'పలమనేరు']
    },
    {
      code: 'konaseema',
      ...
      aliases: ['konaseema'],
      keywords: ['konaseema', 'కోనసీమ', 'అమలాపురం', 'రామచంద్రపురం', 'కొత్తపేట']
    },
    {
      code: 'east-godavari',
      ...
      keywords: ['east godavari', 'తూర్పు గోదావరి', 'రాజమహేంద్రవరం', 'రాజమండ్రి', 'కొవ్వూరు']
    },
    {
      code: 'eluru',
      name_en: 'Eluru',
      name_te: 'ఏలూరు',
      slug: 'eluru',
      keywords: ['eluru', 'ఏలూరు', 'జంగారెడ్డిగూడెం', 'నూజివీడు', 'చింతలపూడి']
    },
    {
      code: 'guntur',
      name_en: 'Guntur',
      name_te: 'గుంటూరు',
      slug: 'guntur',
      keywords: ['guntur', 'గుంటూరు', 'తెనాలి', 'మంగళగిరి', 'పొన్నూరు']
    },
    {
      code: 'kakinada',
      name_en: 'Kakinada',
      name_te: 'కాకినాడ',
      slug: 'kakinada',
      keywords: ['kakinada', 'కాకినాడ', 'తుని', 'పెద్దాపురం', 'పిఠాపురం']
    },
    {
      code: 'krishna',
      name_en: 'Krishna',
      name_te: 'కృష్ణా',
      slug: 'krishna',
      aliases: ['machilipatnam'],
      keywords: ['krishna', 'కృష్ణా', 'machilipatnam', 'మచిలీపట్నం', 'గుడివాడ', 'ఉయ్యూరు']
    },
    {
      code: 'kurnool',
      name_en: 'Kurnool',
      name_te: 'కర్నూలు',
      slug: 'kurnool',
      keywords: ['kurnool', 'కర్నూలు', 'ఆదోని', 'ఎమ్మిగనూరు', 'పత్తికొండ']
    },
    {
      code: 'manyam',
    ...
    },
    {
      ...
      name_te: 'మార్కాపురం',
      slug: 'markapuram',
      keywords: ['markapuram', 'మార్కాపురం', 'giddalur', 'గిద్దలూరు', 'kanigiri', 'కనిగిరి', 'cumbum', 'కంభం', 'యర్రగొండపాలెం', 'పొదిలి']
    },
    {
      code: 'nandyal',
      name_en: 'Nandyal',
      name_te: 'నంద్యాల',
      slug: 'nandyal',
      keywords: ['nandyal', 'నంద్యాల', 'ఆళ్లగడ్డ', 'శ్రీశైలం', 'డోన్', 'ఆత్మకూరు']
    },
    {
      code: 'nellore',
      ...
      aliases: ['nellore'],
      keywords: ['nellore', 'నెల్లూరు', 'కావలి', 'ఆత్మకూరు']
    },
    {
      code: 'ntr',
      name_en: 'NTR (Vijayawada)',
      name_te: 'ఎన్టీఆర్ (విజయవాడ)',
      slug: 'ntr',
      aliases: ['vijayawada'],
      keywords: ['ntr', 'ఎన్టీఆర్', 'vijayawada', 'విజయవాడ', 'నందిగామ', 'తిరువూరు', 'జగ్గయ్యపేట']
    },
    {
      code: 'palnadu',
      name_en: 'Palnadu',
      name_te: 'పల్నాడు',
      slug: 'palnadu',
      keywords: ['palnadu', 'పల్నాడు', 'నరసరావుపేట', 'పిడుగురాళ్ల', 'మాచర్ల', 'గురజాల', 'సత్తెనపల్లి']
    },
    {
      code: 'prakasam',
      name_en: 'Prakasam',
      name_te: 'ప్రకాశం',
      slug: 'prakasam',
      keywords: ['prakasam', 'ప్రకాశం', 'ఒంగోలు', 'ongole', 'addanki', 'అద్దంకి', 'kandukur', 'కందుకూరు', 'దర్శి']
    },
    {
      code: 'srikakulam',
      name_en: 'Srikakulam',
      name_te: 'శ్రీకాకుళం',
      slug: 'srikakulam',
      keywords: ['srikakulam', 'శ్రీకాకుళం', 'టెక్కలి', 'పలాస', 'ఇచ్ఛాపురం']
    },
    {
      code: 'sri-sathya-sai',
      ...
      slug: 'sri-sathya-sai',
      keywords: ['sri sathya sai', 'సత్యసాయి', 'పుట్టపర్తి', 'ధర్మవరం', 'హిందూపురం', 'పెనుకొండ', 'కదిరి']
    },
    {
      code: 'tirupati',
      name_en: 'Tirupati',
      name_te: 'తిరుపతి',
      slug: 'tirupati',
      keywords: ['tirupati', 'తిరుపతి', 'శ్రీకాళహస్తి', 'సూళ్లూరుపేట', 'గూడూరు']
    },
    {
      code: 'visakhapatnam',
      ...
      name_te: 'విశాఖపట్నం',
      slug: 'visakhapatnam',
      keywords: ['visakhapatnam', 'విశాఖపట్నం', 'వైజాగ్', 'గాజువాక', 'భీమిలి']
    },
    {
      code: 'vizianagaram',
      ...
      name_te: 'విజయనగరం',
      slug: 'vizianagaram',
      keywords: ['vizianagaram', 'విజయనగరం', 'బొబ్బిలి', 'చీపురుపల్లి']
    },
    {
      code: 'west-godavari',
      ...
      slug: 'west-godavari',
      aliases: ['bhimavaram'],
      keywords: ['west godavari', 'పశ్చిమ గోదావరి', 'భీమవరం', 'నరసాపురం', 'తాడేపల్లిగూడెం', 'తణుకు']
    },
    {
      code: 'kadapa',
      name_en: 'YSR Kadapa',
      ...
      slug: 'ysr-kadapa',
      aliases: ['kadapa'],
      keywords: ['kadapa', 'కడప', 'ప్రొద్దుటూరు', 'పులివెందుల', 'జమ్మలమడుగు', 'బద్వేలు']
    },
    {
      code: 'hyderabad',
  ...
  // 2. COMPLETE CURRENT AP ADMINISTRATIVE HIERARCHY: DISTRICT -> REVENUE DIVISION -> MANDAL
  const AP_REVENUE_DIVISIONS = {
    'anakapalli': [
      {
        name_en: 'Anakapalli Division',
        name_te: 'అనకాపల్లి రెవెన్యూ డివిజన్',
        code: 'anakapalli-div',
        mandals: [
      ...
      {
        name_en: 'Narsipatnam Division',
        name_te: 'నర్సీపట్నం రెవెన్యూ డివిజన్',
        code: 'narsipatnam-div',
        mandals: [
    ...
    'anantapur': [
      {
        name_en: 'Anantapur Division',
        name_te: 'అనంతపురం రెవెన్యూ డివిజన్',
        code: 'anantapur-div',
        mandals: [
      ...
      {
        name_en: 'Guntakal Division',
        name_te: 'గుంతకల్లు రెవెన్యూ డివిజన్',
        code: 'guntakal-div',
        mandals: [
      ...
      {
        name_en: 'Kalyandurg Division',
        name_te: 'కళ్యాణదుర్గం రెవెన్యూ డివిజన్',
        code: 'kalyandurg-div',
        mandals: [
    ...
    'annamayya': [
      {
        name_en: 'Rayachoti Division',
        name_te: 'రాయచోటి రెవెన్యూ డివిజన్',
        code: 'rayachoti-div',
        mandals: [
      ...
      {
        name_en: 'Madanapalle Division',
        name_te: 'మదనపల్లె రెవెన్యూ డివిజన్',
        code: 'madanapalle-div',
        mandals: [
      ...
      {
        name_en: 'Rajampet Division',
        name_te: 'రాజంపేట రెవెన్యూ డివిజన్',
        code: 'rajampet-div',
        mandals: [
    ...
    'asr': [
      {
        name_en: 'Paderu Division',
        name_te: 'పాడేరు రెవెన్యూ డివిజన్',
        code: 'paderu-div',
        mandals: [
      ...
      {
        name_en: 'Rampachodavaram Division',
        name_te: 'రంపచోడవరం రెవెన్యూ డివిజన్',
        code: 'rampachodavaram-div',
        mandals: [
      ...
      {
        name_en: 'Chintoor Division',
        name_te: 'చింతూరు రెవెన్యూ డివిజన్',
        code: 'chintoor-div',
        mandals: [
    ...
    'bapatla': [
      {
        name_en: 'Bapatla Division',
        name_te: 'బాపట్ల రెవెన్యూ డివిజన్',
        code: 'bapatla-div',
        mandals: [
      ...
      {
        name_en: 'Chirala Division',
        name_te: 'చీరాల రెవెన్యూ డివిజన్',
        code: 'chirala-div',
        mandals: [
    ...
    'chittoor': [
      {
        name_en: 'Chittoor Division',
        name_te: 'చిత్తూరు రెవెన్యూ డివిజన్',
        code: 'chittoor-div',
        mandals: [
      ...
      {
        name_en: 'Nagari Division',
        name_te: 'నగరి రెవెన్యూ డివిజన్',
        code: 'nagari-div',
        mandals: [
      ...
      {
        name_en: 'Palamaner Division',
        name_te: 'పలమనేరు రెవెన్యూ డివిజన్',
        code: 'palamaner-div',
        mandals: [
      ...
      {
        name_en: 'Kuppam Division',
        name_te: 'కుప్పం రెవెన్యూ డివిజన్',
        code: 'kuppam-div',
        mandals: [
    ...
    'konaseema': [
      {
        name_en: 'Amalapuram Division',
        name_te: 'అమలాపురం రెవెన్యూ డివిజన్',
        code: 'amalapuram-div',
        mandals: [
      ...
      {
        name_en: 'Ramachandrapuram Division',
        name_te: 'రామచంద్రపురం రెవెన్యూ డివిజన్',
        code: 'ramachandrapuram-div',
        mandals: [
      ...
      {
        name_en: 'Kothapeta Division',
        name_te: 'కొత్తపేట రెవెన్యూ డివిజన్',
        code: 'kothapeta-div',
        mandals: [
    ...
    'east-godavari': [
      {
        name_en: 'Rajamahendravaram Division',
        name_te: 'రాజమహేంద్రవరం రెవెన్యూ డివిజన్',
        code: 'rajamahendravaram-div',
        mandals: [
      ...
      {
        name_en: 'Kovvur Division',
        name_te: 'కొవ్వూరు రెవెన్యూ డివిజన్',
        code: 'kovvur-div',
        mandals: [
    ...
    'eluru': [
      {
        name_en: 'Eluru Division',
        name_te: 'ఏలూరు రెవెన్యూ డివిజన్',
        code: 'eluru-div',
        mandals: [
      ...
      {
        name_en: 'Jangareddigudem Division',
        name_te: 'జంగారెడ్డిగూడెం రెవెన్యూ డివిజన్',
        code: 'jangareddigudem-div',
        mandals: [
      ...
      {
        name_en: 'Nuzvid Division',
        name_te: 'నూజివీడు రెవెన్యూ డివిజన్',
        code: 'nuzvid-div',
        mandals: [
    ...
    'guntur': [
      {
        name_en: 'Guntur Division',
        name_te: 'గుంటూరు రెవెన్యూ డివిజన్',
        code: 'guntur-div',
        mandals: [
      ...
      {
        name_en: 'Tenali Division',
        name_te: 'తెనాలి రెవెన్యూ డివిజన్',
        code: 'tenali-div',
        mandals: [
    ...
    'kakinada': [
      {
        name_en: 'Kakinada Division',
        name_te: 'కాకినాడ రెవెన్యూ డివిజన్',
        code: 'kakinada-div',
        mandals: [
      ...
      {
        name_en: 'Peddapuram Division',
        name_te: 'పెద్దాపురం రెవెన్యూ డివిజన్',
        code: 'peddapuram-div',
        mandals: [
    ...
    'krishna': [
      {
        name_en: 'Machilipatnam Division',
        name_te: 'మచిలీపట్నం రెవెన్యూ డివిజన్',
        code: 'machilipatnam-div',
        mandals: [
      ...
      {
        name_en: 'Vuyyuru Division',
        name_te: 'ఉయ్యూరు రెవెన్యూ డివిజన్',
        code: 'vuyyuru-div',
        mandals: [
      ...
      {
        name_en: 'Gudivada Division',
        name_te: 'గుడివాడ రెవెన్యూ డివిజన్',
        code: 'gudivada-div',
        mandals: [
          { name_te: 'గుడివాడ', name_en: 'Gudivada' },
          { name_te: 'నందివాడ', name_en: 'Nandivada' },
          { name_te: 'పెదపారుపూడి', name_en: 'Pedaparupudi' }
        ]
      }
    ],
    'kurnool': [
      {
        name_en: 'Kurnool Division',
        name_te: 'కర్నూలు రెవెన్యూ డివిజన్',
        code: 'kurnool-div',
        mandals: [
      ...
      {
        name_en: 'Adoni Division',
        name_te: 'ఆదోని రెవెన్యూ డివిజన్',
        code: 'adoni-div',
        mandals: [
      ...
      {
        name_en: 'Pattikonda Division',
        name_te: 'పత్తికొండ రెవెన్యూ డివిజన్',
        code: 'pattikonda-div',
        mandals: [
    ...
    'manyam': [
      {
        name_en: 'Parvathipuram Division',
        name_te: 'పార్వతీపురం రెవెన్యూ డివిజన్',
        code: 'parvathipuram-div',
        mandals: [
      ...
      {
        name_en: 'Palakonda Division',
        name_te: 'పాలకొండ రెవెన్యూ డివిజన్',
        code: 'palakonda-div',
        mandals: [
    ...
    'markapuram': [
      {
        name_en: 'Markapuram Revenue Division',
        name_te: 'మార్కాపురం రెవెన్యూ డివిజన్',
        code: 'markapuram-div',
        mandals: [
          { name_te: 'మార్కాపురం', name_en: 'Markapuram' },
      ...
      {
        name_en: 'Kanigiri Revenue Division',
        name_te: 'కనిగిరి రెవెన్యూ డివిజన్',
        code: 'kanigiri-div',
        mandals: [
          ...
          { name_te: 'పామూరు', name_en: 'Pamur' },
          { name_te: 'పెదచర్లోపల్లి (పిసిపల్లి)', name_en: 'Pedacherlopalle (PC Palli)' },
          { name_te: 'చంద్రశేఖరపురం (సీఎస్ పురం)', name_en: 'Chandrasekharapuram (CS Puram)' }
        ]
      }
    ],
    'nandyal': [
      {
        name_en: 'Nandyal Division',
        name_te: 'నంద్యాల రెవెన్యూ డివిజన్',
        code: 'nandyal-div',
        mandals: [
      ...
      {
        name_en: 'Dhone Division',
        name_te: 'డోన్ రెవెన్యూ డివిజన్',
        code: 'dhone-div',
        mandals: [
      ...
      {
        name_en: 'Atmakur Division',
        name_te: 'ఆత్మకూరు రెవెన్యూ డివిజన్',
        code: 'atmakur-nandyal-div',
        mandals: [
          { name_te: 'ఆత్మకూరు', name_en: 'Atmakur' },
    ...
    'nellore': [
      {
        name_en: 'Nellore Division',
        name_te: 'నెల్లూరు రెవెన్యూ డివిజన్',
        code: 'nellore-div',
        mandals: [
      ...
      {
        name_en: 'Kavali Division',
        name_te: 'కావలి రెవెన్యూ డివిజన్',
        code: 'kavali-div',
        mandals: [
    ...
    'ntr': [
      {
        name_en: 'Vijayawada Division',
        name_te: 'విజయవాడ రెవెన్యూ డివిజన్',
        code: 'vijayawada-div',
        mandals: [
          { name_te: 'విజయవాడ సెంట్రల్', name_en: 'Vijayawada Central' },
      ...
      {
        name_en: 'Nandigama Division',
        name_te: 'నందిగామ రెవెన్యూ డివిజన్',
        code: 'nandigama-div',
        mandals: [
          { name_te: 'నందిగామ', name_en: 'Nandigama' },
          { name_te: 'జగ్గయ్యపేట', name_en: 'Jaggayyapeta' },
          { name_te: 'కంచికచర్ల', name_en: 'Kanchikacherla' },
          { name_te: 'వీరుళ్లపాడు', name_en: 'Veerullapadu' },
          { name_te: 'చందర్లపాడు', name_en: 'Chandarlapadu' }
        ]
      },
      {
        name_en: 'Tiruvuru Division',
        name_te: 'తిరువూరు రెవెన్యూ డివిజన్',
        code: 'tiruvuru-div',
        mandals: [
          { name_te: 'తిరువూరు', name_en: 'Tiruvuru' },
          { name_te: 'గంపలగూడెం', name_en: 'Gampalagudem' },
          { name_te: 'మైలవరం', name_en: 'Mylavaram' },
          { name_te: 'ఏ.కొండూరు', name_en: 'A.Konduru' },
          { name_te: 'వత్సవాయి', name_en: 'Vatsavai' }
        ]
      }
    ],
    'palnadu': [
      {
        name_en: 'Narasaraopet Division',
        name_te: 'నరసరావుపేట రెవెన్యూ డివిజన్',
        code: 'narasaraopet-div',
        mandals: [
      ...
      {
        name_en: 'Gurazala Division',
        name_te: 'గురజాల రెవెన్యూ డివిజన్',
        code: 'gurazala-div',
        mandals: [
      ...
      {
        name_en: 'Sattenapalle Division',
        name_te: 'సత్తెనపల్లి రెవెన్యూ డివిజన్',
        code: 'sattenapalle-div',
        mandals: [
    ...
    'prakasam': [
      {
        name_en: 'Ongole Revenue Division',
        name_te: 'ఒంగోలు రెవెన్యూ డివిజన్',
        code: 'ongole-div',
        mandals: [
      ...
      {
        name_en: 'Addanki Revenue Division',
        name_te: 'అద్దంకి రెవెన్యూ డివిజన్',
        code: 'addanki-div',
        mandals: [
      ...
      {
        name_en: 'Kandukur Revenue Division',
        name_te: 'కందుకూరు రెవెన్యూ డివిజన్',
        code: 'kandukur-div',
        mandals: [
          { name_te: 'కందుకూరు', name_en: 'Kandukur' },
          { name_te: 'లింగసముద్రం', name_en: 'Lingasamudram' },
          { name_te: 'గుడ్లూరు', name_en: 'Gudluru' },
          { name_te: 'ఉలవపాడు', name_en: 'Ulavapadu' },
          { name_te: 'వోలేటివారిపాలెం', name_en: 'Voletivaripalem' },
    ...
    'srikakulam': [
      {
        name_en: 'Srikakulam Division',
        name_te: 'శ్రీకాకుళం రెవెన్యూ డివిజన్',
        code: 'srikakulam-div',
        mandals: [
      ...
      {
        name_en: 'Tekkali Division',
        name_te: 'టెక్కలి రెవెన్యూ డివిజన్',
        code: 'tekkali-div',
        mandals: [
      ...
      {
        name_en: 'Palasa Division',
        name_te: 'పలాస రెవెన్యూ డివిజన్',
        code: 'palasa-div',
        mandals: [
    ...
    'sri-sathya-sai': [
      {
        name_en: 'Puttaparthi Division',
        name_te: 'పుట్టపర్తి రెవెన్యూ డివిజన్',
        code: 'puttaparthi-div',
        mandals: [
      ...
      {
        name_en: 'Dharmavaram Division',
        name_te: 'ధర్మవరం రెవెన్యూ డివిజన్',
        code: 'dharmavaram-div',
        mandals: [
      ...
      {
        name_en: 'Penukonda Division',
        name_te: 'పెనుకొండ రెవెన్యూ డివిజన్',
        code: 'penukonda-div',
        mandals: [
      ...
      {
        name_en: 'Kadiri Division',
        name_te: 'కదిరి రెవెన్యూ డివిజన్',
        code: 'kadiri-div',
        mandals: [
    ...
    'tirupati': [
      {
        name_en: 'Tirupati Division',
        name_te: 'తిరుపతి రెవెన్యూ డివిజన్',
        code: 'tirupati-div',
        mandals: [
      ...
      {
        name_en: 'Srikalahasti Division',
        name_te: 'శ్రీకాళహస్తి రెవెన్యూ డివిజన్',
        code: 'srikalahasti-div',
        mandals: [
      ...
      {
        name_en: 'Sullurpeta Division',
        name_te: 'సూళ్లూరుపేట రెవెన్యూ డివిజన్',
        code: 'sullurpeta-div',
        mandals: [
      ...
      {
        name_en: 'Gudur Division',
        name_te: 'గూడూరు రెవెన్యూ డివిజన్',
        code: 'gudur-div',
        mandals: [
          { name_te: 'గూడూరు', name_en: 'Gudur' },
    ...
    'visakhapatnam': [
      {
        name_en: 'Visakhapatnam Division',
        name_te: 'విశాఖపట్నం రెవెన్యూ డివిజన్',
        code: 'visakhapatnam-div',
        mandals: [
      ...
      {
        name_en: 'Bheemunipatnam Division',
        name_te: 'భీమునిపట్నం రెవెన్యూ డివిజన్',
        code: 'bheemunipatnam-div',
        mandals: [
    ...
    'vizianagaram': [
      {
        name_en: 'Vizianagaram Division',
        name_te: 'విజయనగరం రెవెన్యూ డివిజన్',
        code: 'vizianagaram-div',
        mandals: [
      ...
      {
        name_en: 'Bobbili Division',
        name_te: 'బొబ్బిలి రెవెన్యూ డివిజన్',
        code: 'bobbili-div',
        mandals: [
      ...
      {
        name_en: 'Cheepurupalle Division',
        name_te: 'చీపురుపల్లి రెవెన్యూ డివిజన్',
        code: 'cheepurupalle-div',
        mandals: [
          { name_te: 'చీపురుపల్లి', name_en: 'Cheepurupalle' },
          { name_te: 'గరివిడి', name_en: 'Garividi' },
          { name_te: 'గుర్లా', name_en: 'Gurla' },
    ...
    'west-godavari': [
      {
        name_en: 'Bhimavaram Division',
        name_te: 'భీమవరం రెవెన్యూ డివిజన్',
        code: 'bhimavaram-div',
        mandals: [
      ...
      {
        name_en: 'Narasapuram Division',
        name_te: 'నరసాపురం రెవెన్యూ డివిజన్',
        code: 'narasapuram-div',
        mandals: [
      ...
      {
        name_en: 'Tadepalligudem Division',
        name_te: 'తాడేపల్లిగూడెం రెవెన్యూ డివిజన్',
        code: 'tadepalligudem-div',
        mandals: [
    ...
    'kadapa': [
      {
        name_en: 'Kadapa Division',
        name_te: 'కడప రెవెన్యూ డివిజన్',
        code: 'kadapa-div',
        mandals: [
      ...
      {
        name_en: 'Jammalamadugu Division',
        name_te: 'జమ్మలమడుగు రెవెన్యూ డివిజన్',
        code: 'jammalamadugu-div',
        mandals: [
      ...
      {
        name_en: 'Badvel Division',
        name_te: 'బద్వేలు రెవెన్యూ డివిజన్',
        code: 'badvel-div',
        mandals: [
    ...
    'hyderabad': [
      {
        name_en: 'Hyderabad & Regional Bureau Division',
        name_te: 'హైదరాబాద్ & రీజినల్ బ్యూరో డివిజన్',
        code: 'hyderabad-div',
        mandals: [
  ...
  // 3. DERIVE FLAT AP_MANDALS DICTIONARY FOR COMPLETE BACKWARD COMPATIBILITY
  const AP_MANDALS = {};
  for (const [distCode, divisions] of Object.entries(AP_REVENUE_DIVISIONS)) {
    AP_MANDALS[distCode] = [];
    divisions.forEach(div => {
      div.mandals.forEach(m => {
        AP_MANDALS[distCode].push({
          name_te: m.name_te,
          name_en: m.name_en,
          division_en: div.name_en,
          division_te: div.name_te
        });
      });
    });
  }
  ...
  (function initMandalAliases() {
    ...
    if (AP_MANDALS['markapuram']) {
      AP_MANDALS['మార్కాపురం'] = AP_MANDALS['markapuram'];
    }
    if (AP_MANDALS['ntr']) {
      AP_MANDALS['vijayawada'] = AP_MANDALS['ntr'];
      AP_MANDALS['విజయవాడ'] = AP_MANDALS['ntr'];
      AP_MANDALS['ఎన్టీఆర్'] = AP_MANDALS['ntr'];
    }
    if (AP_MANDALS['krishna']) {
      AP_MANDALS['machilipatnam'] = AP_MANDALS['krishna'];
      AP_MANDALS['మచిలీపట్నం'] = AP_MANDALS['krishna'];
    }
  })();
  ...
  function getRevenueDivisionsForDistrict(districtCode) {
    if (!districtCode) return [];
    const dObj = getDistrictByCodeOrSlug(districtCode);
    const code = dObj ? dObj.code : String(districtCode).toLowerCase().trim();
    return AP_REVENUE_DIVISIONS[code] || [];
  }

  function getMandalsForDistrict(districtCode, divisionCodeOrName) {
    if (!districtCode) return [];
    const dObj = getDistrictByCodeOrSlug(districtCode);
    const code = dObj ? dObj.code : String(districtCode).toLowerCase().trim();

    if (divisionCodeOrName && AP_REVENUE_DIVISIONS[code]) {
      const divSearch = String(divisionCodeOrName).toLowerCase().trim();
      const matchedDiv = AP_REVENUE_DIVISIONS[code].find(d => 
        d.code === divSearch || 
        d.name_en.toLowerCase().includes(divSearch) || 
        d.name_te.includes(divisionCodeOrName)
      );
      if (matchedDiv) return matchedDiv.mandals;
    }

    if (AP_MANDALS[code] && AP_MANDALS[code].length > 0) {
      return AP_MANDALS[code];
    }
    return [];
  }

  function getMandalsForDivision(districtCode, divisionName) {
    return getMandalsForDistrict(districtCode, divisionName);
  }
  ...
  const exportObj = {
    ...
    revenue_divisions: AP_REVENUE_DIVISIONS,
    mandals: AP_MANDALS,
    getAllDistricts,
    getDistrictsList: getAllDistricts,
    getDistrictByCodeOrSlug,
    getRevenueDivisionsForDistrict,
  ...
  if (typeof window !== 'undefined') {
    ...
    window.AP_REVENUE_DIVISIONS = AP_REVENUE_DIVISIONS;
